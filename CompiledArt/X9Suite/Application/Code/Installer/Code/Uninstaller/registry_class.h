...
class Registry_Class
{
   ...
   public:
      ...
      BOOL  Open_Key              ( const char * key, BOOL createOnFail = TRUE );
      //BOOL  Delete_Key            ( char * key, BOOL deleteSubKeys = FALSE );
      ...
      BOOL  Get_Value_Data_Binary ( char * value, BYTE * data, DWORD buffer_length, const BYTE * default_data );
      ...
      BOOL  Set_Value_Data_Binary ( char * value, BYTE * data, uint32 size );
